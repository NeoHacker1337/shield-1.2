...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    lineHeight: scale(Fonts.size.md * 1.3), // add this
    paddingVertical: scale(6),              // not 0
    minHeight: scale(40),                   // ensure enough height
    fontFamily: Fonts.family.primary,
  },
  button: {
    flexDirection: 'row',
  ...
  // ========== FILE BROWSER STYLES (FIXED FOR VISIBILITY) ==========
  browserContainer: {
    flex: 1,
    backgroundColor: '#0B1724', // Dark navy background
  },
  browserHeader: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  browserPathText: {  // FIXED: Was browserPath, now matches component
  ...
  browserFileItem: {  // FIXED: Matches component usage
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#1B263B',
    padding: 16,
  ...
  dcimImageItem: {  // For grid view in DCIM
    flex: 1,
    aspectRatio: 1,
    margin: 4,
    backgroundColor: '#1B263B',
  ...
  browserFileName: {  // FIXED: Was browserItemName, now matches component
  ...
  dcimFileName: {  // FIXED: Added for DCIM grid view
    color: '#FFFFFF',
    fontSize: 13,
    textAlign: 'center',
    marginTop: 6,
  ...
  browserFileMeta: {  // FIXED: Was browserItemMeta, now matches component
  ...
  // Legacy/alternative names (keep for compatibility if needed)
  browserItem: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#1B263B',
